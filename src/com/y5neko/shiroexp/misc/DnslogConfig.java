...
public class DnslogConfig {
    public static String[] getDnslogDomain(){
        ...
        String response = Tools.bytesToString(Objects.requireNonNull(HttpRequest.httpRequest("http://javaweb.org/new_gen", new FormBody.Builder().add("domain", "dns.su18.org.").build(), headers, "POST")).getResponse());
    ...
    public static String getDnslogRecord(String[] dnslogInfo){
        ...
        return Tools.bytesToString(Objects.requireNonNull(HttpRequest.httpRequest("http://javaweb.org/" + dnslogInfo[2], new FormBody.Builder().add("domain", "dns.su18.org.").build(), headers, "POST")).getResponse());
    }
